...
#ifdef DEBUG_LOG
FILE* fpLog = fopen("/tmp/transtreamproxy.log", "w");
//#undef LOG
...
/* GET /file?file=/home/kos/work/workspace/transtreamproxy/data/20131023%200630%20-%20FASHION%20TV%20-%20instant%20record.ts HTTP/1.0 */
